...
INSERT INTO `analaudos_document_category` (`id`, `name`) VALUES (1,'Laudo de Ultrassonografia Transvaginal');
...
INSERT INTO `analaudos_document_graph` (`id`, `author`, `graphDot`, `timeStamp`, `documentContent_id`, `actions`, `graphJson`) VALUES (33,'Dr Lucio',NULL,'2016-01-26 03:05:15',1,NULL,NULL),(34,'Dr Lucio',NULL,'2016-01-26 03:05:53',1,NULL,NULL),(35,'Dr Lucio','digraph G {w0[fontcolor=\"blue\", label=\"ultrassonografia\"];w1[fontcolor=\"#008000\", label=\"transvaginal\"];w2[fontcolor=\"blue\", label=\"bexiga\"];w3[fontcolor=\"#008000\", label=\"vazia\"];w4[fontcolor=\"#008000\", label=\"utero\"];w0->w1;w0->w2;w2->w3;w0->w4;}','2016-01-26 03:43:49',1,'selectSource:transvaginal,createEdge: s=transvaginal t=ultrassonografia,unselectSource:ultrassonografia,selectSource:bexiga,createEdge: s=bexiga t=ultrassonografia,unselectSource:ultrassonografia,selectSource:vazia,createEdge: s=vazia t=bexiga,unselectSource:bexiga,selectSource:utero,createEdge: s=utero t=ultrassonografia,unselectSource:ultrassonografia',NULL),(36,NULL,'digraph G {w0[fontcolor=\"blue\", label=\"ultrassonografia\"];w1[fontcolor=\"#008000\", label=\"transvaginal\"];w0->w1;}','2016-01-27 15:44:34',NULL,'selectSource:transvaginal; createEdge: s=transvaginal t=ultrassonografia; unselectSource:ultrassonografia','{\"graph\":{\"nodes\":[{\"id\":\"w0\",\"fontcolor\":\"blue\" , \"label\":\"ultrassonografia\", \"word\":\"ultrassonografia\"},{\"id\":\"w1\",\"fontcolor\":\"#008000\" , \"label\":\"transvaginal\", \"word\":\"transvaginal\"}], \"links\":[{\"source\":\"w0\", \"target\":\"w1\"}]}}'),(37,'Dr Silva','digraph G {w0[fontcolor=\"blue\", label=\"ultrassonografia\"];w1[fontcolor=\"#008000\", label=\"transvaginal\"];w2[fontcolor=\"blue\", label=\"bexiga\"];w3[fontcolor=\"#008000\", label=\"vazia\"];w0->w1;w0->w2;w2->w3;}','2016-02-01 15:22:41',1,'selectSource:transvaginal; createEdge: s=transvaginal t=ultrassonografia; unselectSource:ultrassonografia; selectSource:bexiga; createEdge: s=bexiga t=ultrassonografia; unselectSource:ultrassonografia; selectSource:vazia; createEdge: s=vazia t=bexiga; unselectSource:bexiga','{\"graph\":{\"nodes\":[{\"id\":\"w0\",\"fontcolor\":\"blue\" , \"label\":\"ultrassonografia\", \"word\":\"ultrassonografia\"},{\"id\":\"w1\",\"fontcolor\":\"#008000\" , \"label\":\"transvaginal\", \"word\":\"transvaginal\"},{\"id\":\"w2\",\"fontcolor\":\"blue\" , \"label\":\"bexiga\", \"word\":\"bexiga\"},{\"id\":\"w3\",\"fontcolor\":\"#008000\" , \"label\":\"vazia\", \"word\":\"vazia\"}], \"links\":[{\"source\":\"w0\", \"target\":\"w1\"},{\"source\":\"w0\", \"target\":\"w2\"},{\"source\":\"w2\", \"target\":\"w3\"}]}}'),(38,'Dr Silva','digraph G {w0[fontcolor=\"blue\", label=\"ultrassonografia\"];w1[fontcolor=\"#008000\", label=\"transvaginal\"];w2[fontcolor=\"blue\", label=\"bexiga\"];w3[fontcolor=\"blue\", label=\"vazia\"];w4[fontcolor=\"#008000\", label=\"utero\"];w0->w1;w0->w2;w2->w3;w3->w4;}','2016-02-01 15:25:48',1,'selectSource:transvaginal; createEdge: s=transvaginal t=ultrassonografia; unselectSource:ultrassonografia; selectSource:bexiga; createEdge: s=bexiga t=ultrassonografia; unselectSource:ultrassonografia; selectSource:vazia; createEdge: s=vazia t=bexiga; unselectSource:bexiga; selectSource:utero; createEdge: s=utero t=vazia; unselectSource:vazia; selectSource:visualizado','{\"graph\":{\"nodes\":[{\"id\":\"w0\",\"fontcolor\":\"blue\" , \"label\":\"ultrassonografia\", \"word\":\"ultrassonografia\"},{\"id\":\"w1\",\"fontcolor\":\"#008000\" , \"label\":\"transvaginal\", \"word\":\"transvaginal\"},{\"id\":\"w2\",\"fontcolor\":\"blue\" , \"label\":\"bexiga\", \"word\":\"bexiga\"},{\"id\":\"w3\",\"fontcolor\":\"blue\" , \"label\":\"vazia\", \"word\":\"vazia\"},{\"id\":\"w4\",\"fontcolor\":\"#008000\" , \"label\":\"útero\", \"word\":\"utero\"}], \"links\":[{\"source\":\"w0\", \"target\":\"w1\"},{\"source\":\"w0\", \"target\":\"w2\"},{\"source\":\"w2\", \"target\":\"w3\"},{\"source\":\"w3\", \"target\":\"w4\"}]}}');
...
INSERT INTO `auditorship_crud` (`id`, `description`, `ocurrencyDate`, `terminal`, `created`, `deleted`, `entityId`, `updated`, `applicationUser`, `applicationEntity`) VALUES (1,'Laudo de Ultrassonografia Transvaginal','2015-01-22 14:53:11','localhost','','\0',1,'\0',1,26),(2,'1:Ultrassonografia de teste','2015-01-22 14:54:42','localhost','','\0',1,'\0',1,27),(3,'author=\'\'->\'Teste\'; documentContent.id=->1; ','2015-01-22 14:55:32','localhost','\0','\0',1,'',1,25);
...
INSERT INTO `auditorship_process` (`id`, `description`, `ocurrencyDate`, `terminal`, `applicationProcess`, `applicationUser`) VALUES (1,NULL,'2015-01-21 17:14:54','localhost',9,1),(2,NULL,'2015-01-22 14:52:33','localhost',9,1),(3,NULL,'2015-01-22 15:12:08','localhost',9,1),(4,NULL,'2015-01-23 11:24:26','localhost',9,1);
...
INSERT INTO `security_group` (`id`, `name`) VALUES (1,'admin'),(2,'user');
...
INSERT INTO `security_module` (`id`, `name`) VALUES (1,'br.com.orionsoft.monstrengo'),(2,'br.com.valentin.analaudos');
...
INSERT INTO `security_right_process` (`id`, `executeAllowed`, `securityGroup`, `applicationProcess`) VALUES (1,'',1,1),(2,'',1,2),(3,'',1,3),(4,'',1,4),(5,'',1,5),(6,'',1,6),(7,'',1,7),(8,'',1,8),(9,'',1,9),(10,'',1,10),(11,'',1,11),(12,'',1,12),(13,'',1,13),(14,'\0',2,1),(15,'\0',2,2),(16,'\0',2,3),(17,'\0',2,4),(18,'\0',2,5),(19,'\0',2,6),(20,'\0',2,7),(21,'\0',2,8),(22,'\0',2,9),(23,'\0',2,10),(24,'\0',2,11),(25,'\0',2,12),(26,'\0',2,13);
...
INSERT INTO `security_user` (`id`, `inactive`, `login`, `name`, `password`) VALUES (1,'\0','admin','admin','21232f297a57a5a743894a0e4a801fc3'),(2,'\0','user','user','ee11cbb19052e40b07aac0ca060c23ee');
...
INSERT INTO `security_user_group` (`securityGroup`, `applicationUser`) VALUES (1,1),(2,2);
...
-- Dump completed on 2016-02-04  1:20:24
