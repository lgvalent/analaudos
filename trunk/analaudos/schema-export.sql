...
create table analaudos_document_graph (id bigint not null auto_increment, author varchar(50), source TEXT, timeStamp datetime, documentContent_id bigint, primary key (id)) ENGINE=InnoDB
